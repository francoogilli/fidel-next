...
const detailSections = [
  {
    ...
    image: "/fidel/distribuidoras1.png",
    reverse: false,
  },
  {
    icon: RefreshCw,
    ...
    image: "/fidel/distribuidoras2.png",
    reverse: true,
  },
  {
    icon: Users,
    ...
    image: "/fidel/distribuidoras3.png",
    reverse: false,
  },
  {
    icon: Wallet,
    ...
    image: "/fidel/distribuidoras4.png",
    reverse: true,
  },
];
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col items-center md:items-end text-center md:text-right">
              ...
              <h2
                ...
                style={{ fontFamily: "Plus Jakarta Sans" }}
              >
                <img src="/fidel/fidel1.svg" alt="Fidel" style={{ height: "1.5em", width: "auto", display: "inline", verticalAlign: "-0.35em", marginRight: "0.15em" }} />Fidel conecta ventas, stock, cobranzas y administración
              </h2>
              <p
            ...
            <div className="flex justify-center">
              <InstagramReel
                ...
                thumbnail="/fidel/reels/distribuidoras.jpg"
              />
            </div>
          </div>
        </div>
