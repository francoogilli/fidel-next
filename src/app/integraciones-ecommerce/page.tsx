...
export const metadata: Metadata = {
  ...
  description:
    "Conectá Tienda Nube o WooCommerce con Fidel. Sincronizá productos, precios y stock, y recibí los pedidos de tu tienda online en el sistema.",
};
...
const setupSteps = [
  {
    ...
    text: "Contratá Fidel y compartinos el acceso a la cuenta de Tienda Nube o WooCommerce que querés vincular.",
  },
  {
    title: "Prepará la tienda",
    text: "La tienda no debe tener productos ni categorías cargadas previamente. La carga y las futuras modificaciones se hacen desde Fidel.",
  },
  {
    title: "Diseñala a tu manera",
    text: "La creación y el diseño de la tienda online quedan a tu cargo para que tenga la identidad que prefieras.",
  },
];
        ...
        <div className="mx-auto mt-16 grid max-w-6xl items-center gap-8 md:grid-cols-[minmax(0,0.9fr)_minmax(360px,1.1fr)] md:gap-14 lg:mt-20">
          <div className="max-w-xl">
            ...
            <div className="mt-6 space-y-5 text-base leading-relaxed text-[#5c5c5c] md:text-lg" style={{ fontFamily: "Satoshi" }}>
              <p>
                Vinculá masivamente tus productos de Fidel con Tienda Nube o WooCommerce. El stock y la lista de precios se mantienen actualizados para que puedas vender online con la información de tu negocio.
              </p>
              <p>
                Las compras ingresan automáticamente como pedidos en Fidel, con el cliente ya cargado, listos para facturar.
              </p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[24px] border border-[#e3eddc] bg-[#f7fbf5] p-5 sm:p-7" aria-label="Esquema de integración entre la tienda online y Fidel">
            <div className="flex items-center justify-between gap-3 border-b border-[#dce9d8] pb-4">
              <span className="text-sm font-semibold text-[#305d36]" style={{ fontFamily: "Plus Jakarta Sans" }}>Tu tienda online</span>
      ...
      <section className="mx-auto mt-28 max-w-7xl md:mt-40" aria-labelledby="sync-title">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-[#5c5c5c] md:text-lg" style={{ fontFamily: "Satoshi" }}>
            Cargá y modificá los productos desde Fidel. Estos datos se reflejan en tu tienda.
          </p>
        </div>
        <div className="mx-auto mt-14 grid max-w-6xl items-stretch gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(300px,0.85fr)] lg:gap-12">
          ...
          <div className="flex flex-col justify-center rounded-[28px] border border-[#f0e4cc] bg-[#fff9ef] p-7 md:p-9">
            ...
            <h3 className="mt-7 text-2xl font-bold tracking-[-0.035em] md:text-3xl" style={{ fontFamily: "Plus Jakarta Sans" }}>Vendé con información al día</h3>
          ...
          <div className="overflow-hidden rounded-[36px] border border-[#d8e9d9] bg-[#eff9ec] px-5 py-8 md:px-10 md:py-12">
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-[0.9fr_1.1fr]">
              <div className="flex flex-col justify-between gap-10 rounded-[28px] bg-[#252525] p-6 text-white shadow-[0_18px_30px_-22px_rgba(37,37,37,0.9)] md:p-8">
                <div>
                  <p className="text-lg font-semibold md:text-xl" style={{ fontFamily: "Plus Jakarta Sans" }}>Implementación</p>
                  <p className="mt-1 text-sm text-white/70" style={{ fontFamily: "Satoshi" }}>Pago único para vincular tu tienda</p>
                </div>
              ...
              <div className="rounded-[28px] border border-[#d8e9d9] bg-white/85 p-6 md:p-8">
                ...
                <p className="mt-1 text-sm text-[#526e56]" style={{ fontFamily: "Satoshi" }}>Según el plan de Fidel que contrates</p>
                <dl className="mt-6 divide-y divide-[#e3eddc]">
                  {planLimits.map((plan) => (
                    <div key={plan.name} className="flex items-center justify-between gap-3 py-3 first:pt-0 last:pb-0">
                      ...
                      <dd className="whitespace-nowrap text-base font-bold tabular-nums sm:text-lg" style={{ fontFamily: "Plus Jakarta Sans" }}>{plan.quantity} <span className="text-sm font-normal text-[#526e56]">productos</span></dd>
                    </div>
                  ))}
                </dl>
              </div>
            ...
            <div className="mt-6 flex items-start gap-3 border-t border-[#d8e9d9] pt-5 text-sm leading-relaxed text-[#405d43] md:text-base" style={{ fontFamily: "Satoshi" }}>
              ...
              <p>Cada variante cuenta como un producto al vincular Tienda Nube. Si necesitás sumar más productos, podés cambiar de plan.</p>
            </div>
            <Link href="/planes" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-[#205d2a] underline decoration-[#7ebf78] underline-offset-4 hover:text-[#123d19] focus-visible:rounded focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#205d2a]">
