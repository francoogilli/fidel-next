      ...
      <main className="min-h-screen py-24 md:py-32 px-4 md:px-6 max-w-7xl mx-auto">
        <div id="dia">
          <SectionHeading
            ...
            title="Así trabaja una distribuidora"
