...
export const metadata: Metadata = {
  ...
  description: "Fidel es un sistema avanzado de gestión empresarial diseñado para optimizar procesos y mejorar la productividad.",
  keywords: ["Fidel", "Sistema de Gestión", "Gestión Empresarial", "Productividad"],
  openGraph: {
    title: "Fidel - Sistema Web de Gestión",
    description: "Optimiza los procesos de tu empresa con Fidel, el sistema web de gestión empresarial.",
