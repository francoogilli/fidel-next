...
import { useSales } from "@/context/SalesContext"; // ← del Archivo 2

// ── ShinyPrice (sin cambios) ──────────────────────────────────────────────────
...
export default function PricingCard({ viewComparison }: Props) {
  // Lógica del Archivo 2: contexto de ventas y fetch de precios
  ...
  useEffect(() => {
    const fetchPlans = async () => {
      try {
        ...
        // silencioso, usa precios de fallback de pricingInfo
      } finally {
        setLoading(false);
      }
    };
  ...
  // Mezcla precios dinámicos con la info base (igual que Archivo 2)
  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-[1] w-full h-full bg-gradient-to-b from-[#FCFBF9] via-transparent to-white pointer-events-none" />
      <div className="absolute inset-0 z-[1] w-full h-full bg-white/30 pointer-events-none" />
      <div className="absolute inset-0 z-[1] w-full h-full bg-gradient-to-b from-transparent via-transparent to-white pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-[87rem] mx-auto px-6">
        ...
        {/* Cards — usa pricingWithDynamicPrices en lugar de pricingInfo */}
        <motion.div
          ...
          {pricingWithDynamicPrices.map((pricing) => {
            ...
            const cardContent = (
              ...
              >
                ...
                {/* Precio — dinámico, con ShinyPrice del diseño nuevo */}
                <div className="mb-5">
                  <div className="flex items-baseline gap-2 h-10">
                    ...
                    <span className="text-[13px] text-neutral-500 mb-0.5 whitespace-nowrap">
                      +IVA/mes
                    </span>
                  </div>
                </div>
                ...
                {/* CTA — usa nroVentas del contexto (Archivo 2) */}
                <button
                  onClick={() =>
                    window.open(
