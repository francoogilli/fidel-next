...
function IntegrationMark({ mark }: { mark: Mark }) {
  if (mark === "mercado-libre") {
    return (
      <span className="grid h-[50px] w-[50px] place-items-center overflow-hidden rounded-[9px] max-[700px]:h-10 max-[700px]:w-10" aria-hidden="true">
        <Image className="h-[50px] w-[50px] object-contain max-[700px]:h-10 max-[700px]:w-10" src="/fidel/mercado-libre.png" alt="" width={50} height={50} sizes="50px" />
      </span>
    );
  }
  ...
  if (mark === "woocommerce") {
    return (
      <span className="grid h-[50px] w-[50px] place-items-center overflow-hidden rounded-[9px] max-[700px]:h-10 max-[700px]:w-10" aria-hidden="true">
        <Image className="h-[50px] w-[50px] object-contain max-[700px]:h-10 max-[700px]:w-10" src="/fidel/woocommerce.svg" alt="" width={50} height={50} sizes="50px" />
      </span>
    );
  }
