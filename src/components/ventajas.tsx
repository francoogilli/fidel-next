...
export default function Ventajas() {
  return (
    ...
    >
      <div className="relative max-w-7xl xl:max-w-[90rem] mb-8 mx-auto px-4 md:px-3">
        ...
        <div className="font-sans">
          <div className="mx-auto">
            ...
            >
              Todo lo que necesitás para gestionar tu negocio de manera
              sencilla, segura y sin complicaciones, con el mejor respaldo y un
              equipo para ayudarte.
            </h4>
              ...
              <div className="col-span-1 w-full h-full order-5 md:order-none bg-white border border-[#e9e9e9d3] rounded-[32px] flex transition-transform duration-300 ease-in-out hover:scale-105">
                <div className="p-10 text-center flex flex-col justify-center flex-1 transform scale-95 hover:scale-90 transition-transform duration-300 ease-in-out">
                  ...
                  <p className="text-gray-500 text-base">
                    ...
                    necesitan alguien del otro lado. En Fidel, combinamos lo
                    mejor de los dos mundos para que nunca te quedes sin
                    respuesta.
                  </p>
                </div>
              </div>
